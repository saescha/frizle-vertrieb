...
class ChoicesController extends AppController
{
    ...
    public function index()
    {
		...
		$query = $this->Choices->find()->where( ['Questions.type <>' => 'F' ]);
        $choices = $this->paginate($query);
    ...
    public function add()
    {
        ...
        $questions = $this->Choices->Questions->find('all', ['limit' => 200])->toArray();
		$questions2 = array();
		foreach( $questions as $q){
			
			$questions2[$q['id']] = $q['text'];
		}
